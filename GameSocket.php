...
class GameSocket implements MessageComponentInterface {
    ...
    public function onOpen(ConnectionInterface $conn) {
        $this->clients->attach($conn,'notset');
    ...
    public function onMessage(ConnectionInterface $from, $msg){
        ...
        if($this->clients[$from] !== 'notset'){
            //if yes continue

        }else{
            //if no associate it to the connection
    ...
    private function associateUserToConnection(ConnectionInterface $from, $msg){
